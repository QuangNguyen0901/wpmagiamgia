                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            'id' => 'trans_coupon',
                            'type' => 'text',
                            'title' => esc_html__('Coupon Slug', 'reviews') ,
                            'desc' => esc_html__('Input slug you want to use for the coupon single page.', 'reviews'),
                            'default' => 'coupon'
                        ),
                        array(
                            'id' => 'trans_coupon-category',
                            'type' => 'text',
                            'title' => esc_html__('Coupons Category Slug', 'reviews') ,
                            'desc' => esc_html__('Input slug you want to use for the coupon categories.', 'reviews'),
                            'default' => 'coupon-category'
                        ),
                        array(
                            'id' => 'trans_coupon-store',
                            'type' => 'text',
                            'title' => esc_html__('Coupons Stores Slug', 'reviews') ,
                            'desc' => esc_html__('Input slug you want to use for the coupon stores.', 'reviews'),
